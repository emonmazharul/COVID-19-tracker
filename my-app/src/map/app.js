...
import corona from './utils/img/corona.png'
...
function Header(){
	return (
		<div className="mainHeader">
			<div>
				<a href="https://github.com/emonmazharul" target="_blank" rel="noopener noreferrer">
					<img src={corona} className="headerImg" alt="headerImg"/>
				</a>
			</div>
			<div>
